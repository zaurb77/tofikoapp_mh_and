...
import com.angaihouse.databinding.ActivityTermsAndConditionBinding;
...
public class TermsAndConditionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.title.setText(Constants.TERMS_AND_CONDITIONS);
        binding.title1.setText(Constants.TERMS_AND_CONDITIONS);
