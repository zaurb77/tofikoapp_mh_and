...
public class TasteCustomizationMenuAdapter1 extends RecyclerView.Adapter<TasteCustomizationMenuAdapter1.ViewHolder> {

    Activity activity;
    int select = -1;
    private ArrayList<DetailPojo.Responsedata.Taste> arrayList;
    private DetailActivity.ItemClickListener itemClickListener;
    StoreUserData storeUserData;

    public TasteCustomizationMenuAdapter1(Activity activity, ArrayList<DetailPojo.Responsedata.Taste> arrayList, DetailActivity.ItemClickListener itemClickListener) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        final DetailPojo.Responsedata.Taste pojo = arrayList.get(position);
