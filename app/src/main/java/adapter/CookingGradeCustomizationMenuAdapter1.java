...
public class CookingGradeCustomizationMenuAdapter1 extends RecyclerView.Adapter<CookingGradeCustomizationMenuAdapter1.ViewHolder> {

    Activity activity;
    int select = -1;
    private ArrayList<DetailPojo.Responsedata.CookingGrades> arrayList;
    private DetailActivity.ItemClickListener itemClickListener;
    StoreUserData storeUserData;



    public CookingGradeCustomizationMenuAdapter1(Activity activity, ArrayList<DetailPojo.Responsedata.CookingGrades> arrayList, DetailActivity.ItemClickListener itemClickListener) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        final DetailPojo.Responsedata.CookingGrades pojo = arrayList.get(position);
