...
public class TestCustomizationMenuAdapter extends RecyclerView.Adapter<TestCustomizationMenuAdapter.ViewHolder> {
    ...
    public TestCustomizationMenuAdapter(Activity activity, ArrayList<CategoryItemPojo.ResponseData.PaidCustomization> arrayList, MenuActivity.ItemClickListener itemClickListener) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            holder.binding.itemName.setText(Html.fromHtml("Add on " + pojo.name));
        }
