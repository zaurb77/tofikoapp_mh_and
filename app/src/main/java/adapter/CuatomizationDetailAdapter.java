...
public class CuatomizationDetailAdapter extends RecyclerView.Adapter<CuatomizationDetailAdapter.ViewHolder> {
    ...
    public CuatomizationDetailAdapter(Activity activity, ArrayList<CustomizationPojo.ResponseData> arrayList, DetailActivity.ItemClickListener itemClickListener) {
